...
function ImgContext(props){
    return(
        <Link to='/board/gateball' style={{textDecoration:'none'}}>
        ...
        <div>
            ...
            <div style={{display:'flex',justifyContent:'space-between'}}>
                <div>
                    ...
                    <p style={{display:'inline-block',fontSize:'20px'}}>게이트볼</p>
                </div>
            ...
            <div style={{overflowY: 'scroll',height:'400px',border:'1px solid #ccc', padding:"10px"}}>
                <ImgContext title="매주 월요일마다 게이트볼..." content="쉼터공원에서 아침 9시에 게이트볼 같이..." writer="홍길동"/>
                <hr/>
                <Context title="매주 월요일마다 게이트볼..." content="쉼터공원에서 아침 9시에 게이트볼 같이..." writer="김길동"/>
                <hr/>
                <ImgContext title="매주 목요일마다 게이트볼..." content="쉼터공원에서 아침 9시에 게이트볼 같이..." writer="이길동"/>
                <hr/>
                <Context title="매주 월요일마다 게이트볼..." content="쉼터공원에서 아침 9시에 게이트볼 같이..." writer="박길동"/>
                <hr/>
                <ImgContext title="매주 금요일마다 게이트볼..." content="쉼터공원에서 아침 9시에 게이트볼 같이..." writer="최길동"/>
            </div>
        </div>
    );
}